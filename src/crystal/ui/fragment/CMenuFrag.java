...
public class CMenuFrag extends Fragment{
    ...
    public void build(Group parent) {
        ...
        if (mobile) {
            ...
            parent.fill(
                    c -> c.bottom().right().button("", Styles.discordt, ui.discord::show).size(84, 45).name("discord"));
            ...
            }).size(200, 60).name("becheck").update(t -> t.getLabel()
                    .setColor(becontrol.isUpdateAvailable()
                            ? Tmp.c1.set(Color.white).lerp(Pal.accent, Mathf.absin(5f, 1f))
                            : Color.white)));
        }
        ...
        parent.fill((x, y, w, h) -> {
            ...
            float fy = (int) (Core.graphics.getHeight() - 6 - logoh) + logoh / 2
                    - (Core.graphics.isPortrait() ? Scl.scl(30f) : 0f);
    ...
    private void buildMobile() {
        ...
        MobileButton play = new MobileButton(Icon.play, "@campaign", () -> checkPlay(ui.planet::show)),
    ...
    private void buildDesktop() {
        ...
        container.table(background, t -> {
            ...
            buttons(t,
                    ...
                    new Buttoni("@editor", Icon.terrain, () -> checkPlay(ui.maps::show)),
                    //steam ? new Buttoni("@workshop", Icon.book, platform::openWorkshop) : null,
                    new Buttoni("@mods", Icon.book, ui.mods::show),
                    // not enough space for this button
                    new Buttoni("@launcher", Icon.paste, CustomUiList.launcher::show),
    ...
    private void fadeOutMenu() {
        ...
        submenu.clearActions();
        submenu.actions(Actions.alpha(1f), Actions.alpha(0f, 0.2f, Interp.fade),
